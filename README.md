...
> **Tag [`v0.8.0-rc`](https://github.com/bmcc-DEV/B.A.S.E./releases/tag/v0.8.0-rc)** · plano [Path to v0.8](base-vault/18%20-%20Path%20to%20v0.8/18.00%20-%20Index.md) · [CHANGELOG](CHANGELOG.md):
