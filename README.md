...
> **Tag [`v1.0.0-rc`](https://github.com/bmcc-DEV/B.A.S.E./releases/tag/v1.0.0-rc)** · plano [Path to v1.0](base-vault/20%20-%20Path%20to%20v1.0/20.00%20-%20Index.md) · [CHANGELOG](CHANGELOG.md):
