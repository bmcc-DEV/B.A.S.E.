...
**v1.0.0 ✅ · tag [`v1.1.0-rc`](https://github.com/bmcc-DEV/B.A.S.E./releases/tag/v1.1.0-rc) · [[21 - Path to v1.1/21.00 - Index|Path to v1.1]] · [[20 - Path to v1.0/20.00 - Index|Path to v1.0]] · [[19 - Path to v0.9/19.00 - Index|Path to v0.9]] · [[12 - Path to Real/12.20 - Pilot Case Study|Pilot Case Study]] · [[12 - Path to Real/12.02 - Maturity Matrix|Maturity Matrix]]**
